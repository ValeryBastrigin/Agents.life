...
export const translations = {
  ru: {
    ...
    myPlan: 'Мой тариф',
    credits: 'кредитов',
    creditsPerDay: 'кредитов/день',
    used: 'Использовано',
    limitExceeded: 'Лимит дня исчерпан! Купите подписку.',
    upgrade: 'Купить',
    downgrade: 'Понизить',
    select: 'Выбрать',
    active: 'Активен',
    ...
    perMonth: '/мес',
    planFree: 'Free',
    planBasic: 'Базовые лимиты',
    planPro: 'Pro',
    planExtended: 'Расширенные лимиты',
  ...
  en: {
    ...
    used: 'Used',
    limitExceeded: 'Daily limit exceeded! Upgrade your plan.',
    upgrade: 'Upgrade',
    downgrade: 'Downgrade',
    select: 'Select',
    active: 'Active',
    ...
    perMonth: '/mo',
    planFree: 'Free',
    planBasic: 'Basic limits',
    planPro: 'Pro',
    planExtended: 'Extended limits',
    planUnlimited: 'Unlimited',
