...
const AccountantBackground = () => {
  ...
  // Purple/violet theme colors for Financial Assistant
  const darkColors = [
    'rgba(147, 51, 234, 0.3)',   // purple-600
    'rgba(168, 85, 247, 0.25)',  // purple-500
    'rgba(192, 132, 252, 0.2)',  // purple-400
    'rgba(216, 180, 254, 0.25)', // purple-300
  ];

  const lightColors = [
    'rgba(243, 232, 255, 0.4)',   // light purple-100
    'rgba(233, 213, 255, 0.35)',  // light purple-200
    'rgba(216, 180, 254, 0.3)',   // light purple-300
    'rgba(192, 132, 252, 0.35)',  // light purple-400
  ];
...
export default AccountantBackground;